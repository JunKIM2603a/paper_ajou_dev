...
def main() -> None:
    ...
    if args.sort_metric != f"best_{PRIMARY_PAUC_METRIC}":
        extra_metric_columns.append(f"metrics.best_{PRIMARY_PAUC_METRIC}")
        extra_metric_headers.append(f"best_{PRIMARY_PAUC_METRIC}")
    columns = [
        "tags.model_name",
