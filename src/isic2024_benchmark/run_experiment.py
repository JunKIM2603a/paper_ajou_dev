...
from isic2024_benchmark.config_utils import expand_search_space, load_json, sanitize_run_name
from isic2024_benchmark.data import ImageClassificationDataset, build_manifest, create_splits, resolve_dataset_root
from isic2024_benchmark.metrics import PRIMARY_PAUC_METRIC
from isic2024_benchmark.models import build_model
from isic2024_benchmark.reproducibility import (
    DEFAULT_SEED,
    make_torch_generator,
    make_worker_init_fn,
    set_global_seed,
)
from isic2024_benchmark.runtime_env import ensure_expected_conda_env, get_default_mlflow_tracking_uri, load_project_env
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--experiment-name",
        default="ISIC2024-Image-Benchmark",
