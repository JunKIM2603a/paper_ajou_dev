...
from isic2024_benchmark.tabular_terms import ORACLE, RELAXED, STRICT_BASE, STRICT_FE, STRICT_MAIN_INPUT, normalize_feature_set_name
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default="artifacts/tabular/isic2024_strict_main_input.csv")
