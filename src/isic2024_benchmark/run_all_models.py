...
from isic2024_benchmark.runtime_env import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run every model config under src/image_baselines.")
    parser.add_argument("--config-root", default="src/image_baselines")
