...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--child-sort-metric", default="test_average_precision")
...
def build_parent_summary(parent, parent_sort_metric: str) -> str:
    ...
    items.extend((label_from_metric(metric), format_metric(parent.get(f"metrics.{metric}"))) for metric in PARENT_METRICS)
