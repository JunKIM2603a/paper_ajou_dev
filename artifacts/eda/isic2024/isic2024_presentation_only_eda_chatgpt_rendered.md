...
| 12 | tbp_lv_deltaB | 색채·광학 특징 |
| 13 | tbp_lv_deltaL | 색채·광학 특징 |
| 14 | tbp_lv_deltaLB | 색채·광학 특징 |
| 15 | tbp_lv_deltaLBnorm | 색채·광학 특징 |
| 16 | tbp_lv_stdL | 색채·광학 특징 |
| 17 | tbp_lv_stdLExt | 색채·광학 특징 |
| 18 | attribution | 식별자 및 출처 |
| 19 | copyright_license | 식별자 및 출처 |
| 20 | isic_id | 식별자 및 출처 |
| 21 | lesion_id | 식별자 및 출처 |
| 22 | patient_id | 식별자 및 출처 |
| 23 | target | 예측 타깃 |
| 24 | anatom_site_general | 위치·공간 좌표 |
| 25 | tbp_lv_location | 위치·공간 좌표 |
| 26 | tbp_lv_location_simple | 위치·공간 좌표 |
| 27 | tbp_lv_x | 위치·공간 좌표 |
| 28 | tbp_lv_y | 위치·공간 좌표 |
| 29 | tbp_lv_z | 위치·공간 좌표 |
| 30 | iddx_1 | 임상·병리 정보 |
| 31 | iddx_2 | 임상·병리 정보 |
| 32 | iddx_3 | 임상·병리 정보 |
| 33 | iddx_4 | 임상·병리 정보 |
| 34 | iddx_5 | 임상·병리 정보 |
| 35 | iddx_full | 임상·병리 정보 |
| 36 | mel_mitotic_index | 임상·병리 정보 |
| 37 | mel_thick_mm | 임상·병리 정보 |
| 38 | tbp_lv_dnn_lesion_confidence | 임상·병리 정보 |
| 39 | image_type | 촬영 조건 메타데이터 |
| 40 | tbp_tile_type | 촬영 조건 메타데이터 |
| 41 | clin_size_long_diam_mm | 형태·기하 특징 |
| 42 | tbp_lv_areaMM2 | 형태·기하 특징 |
| 43 | tbp_lv_area_perim_ratio | 형태·기하 특징 |
| 44 | tbp_lv_eccentricity | 형태·기하 특징 |
| 45 | tbp_lv_minorAxisMM | 형태·기하 특징 |
| 46 | tbp_lv_nevi_confidence | 형태·기하 특징 |
| 47 | tbp_lv_norm_border | 형태·기하 특징 |
| 48 | tbp_lv_norm_color | 형태·기하 특징 |
| 49 | tbp_lv_perimeterMM | 형태·기하 특징 |
| 50 | tbp_lv_radial_color_std_max | 형태·기하 특징 |
| 51 | tbp_lv_symm_2axis | 형태·기하 특징 |
| 52 | tbp_lv_symm_2axis_angle | 형태·기하 특징 |
| 53 | age_approx | 환자 인구통계 |
| 54 | sex | 환자 인구통계 |
...
| 12 | 색채·광학 특징 | tbp_lv_deltaB | Strict (메인용) | 0.000 |
| 13 | 색채·광학 특징 | tbp_lv_deltaL | Strict (메인용) | 0.000 |
| 14 | 색채·광학 특징 | tbp_lv_deltaLB | Strict (메인용) | 0.000 |
| 15 | 색채·광학 특징 | tbp_lv_deltaLBnorm | Strict (메인용) | 0.000 |
| 16 | 색채·광학 특징 | tbp_lv_stdL | Strict (메인용) | 0.000 |
| 17 | 색채·광학 특징 | tbp_lv_stdLExt | Strict (메인용) | 0.000 |
| 18 | 식별자 및 출처 | attribution | Relaxed (보조용) | 0.000 |
| 19 | 식별자 및 출처 | copyright_license | Relaxed (보조용) | 0.000 |
| 20 | 식별자 및 출처 | isic_id | Not Feature (입력 제외) | 0.000 |
| 21 | 식별자 및 출처 | lesion_id | Oracle (참고용) | 94.500 |
| 22 | 식별자 및 출처 | patient_id | Not Feature (입력 제외) | 0.000 |
| 23 | 예측 타깃 | target | Label (예측 타깃) | 0.000 |
| 24 | 위치·공간 좌표 | anatom_site_general | Strict (메인용) | 1.435 |
| 25 | 위치·공간 좌표 | tbp_lv_location | Strict (메인용) | 0.000 |
| 26 | 위치·공간 좌표 | tbp_lv_location_simple | Strict (메인용) | 0.000 |
| 27 | 위치·공간 좌표 | tbp_lv_x | Strict (메인용) | 0.000 |
| 28 | 위치·공간 좌표 | tbp_lv_y | Strict (메인용) | 0.000 |
| 29 | 위치·공간 좌표 | tbp_lv_z | Strict (메인용) | 0.000 |
| 30 | 임상·병리 정보 | iddx_1 | Oracle (참고용) | 0.000 |
| 31 | 임상·병리 정보 | iddx_2 | Oracle (참고용) | 99.734 |
| 32 | 임상·병리 정보 | iddx_3 | Oracle (참고용) | 99.734 |
| 33 | 임상·병리 정보 | iddx_4 | Oracle (참고용) | 99.863 |
| 34 | 임상·병리 정보 | iddx_5 | Oracle (참고용) | 100.000 |
| 35 | 임상·병리 정보 | iddx_full | Oracle (참고용) | 0.000 |
| 36 | 임상·병리 정보 | mel_mitotic_index | Oracle (참고용) | 99.987 |
| 37 | 임상·병리 정보 | mel_thick_mm | Oracle (참고용) | 99.984 |
| 38 | 임상·병리 정보 | tbp_lv_dnn_lesion_confidence | Oracle (참고용) | 0.000 |
| 39 | 촬영 조건 메타데이터 | image_type | Strict (메인용) | 0.000 |
| 40 | 촬영 조건 메타데이터 | tbp_tile_type | Strict (메인용) | 0.000 |
| 41 | 형태·기하 특징 | clin_size_long_diam_mm | Strict (메인용) | 0.000 |
| 42 | 형태·기하 특징 | tbp_lv_areaMM2 | Strict (메인용) | 0.000 |
| 43 | 형태·기하 특징 | tbp_lv_area_perim_ratio | Strict (메인용) | 0.000 |
| 44 | 형태·기하 특징 | tbp_lv_eccentricity | Strict (메인용) | 0.000 |
| 45 | 형태·기하 특징 | tbp_lv_minorAxisMM | Strict (메인용) | 0.000 |
| 46 | 형태·기하 특징 | tbp_lv_nevi_confidence | Strict (메인용) | 0.000 |
| 47 | 형태·기하 특징 | tbp_lv_norm_border | Strict (메인용) | 0.000 |
| 48 | 형태·기하 특징 | tbp_lv_norm_color | Strict (메인용) | 0.000 |
| 49 | 형태·기하 특징 | tbp_lv_perimeterMM | Strict (메인용) | 0.000 |
| 50 | 형태·기하 특징 | tbp_lv_radial_color_std_max | Strict (메인용) | 0.000 |
| 51 | 형태·기하 특징 | tbp_lv_symm_2axis | Strict (메인용) | 0.000 |
| 52 | 형태·기하 특징 | tbp_lv_symm_2axis_angle | Strict (메인용) | 0.000 |
| 53 | 환자 인구통계 | age_approx | Strict (메인용) | 0.698 |
| 54 | 환자 인구통계 | sex | Strict (메인용) | 2.872 |
...
| 12 | tbp_lv_H | 색채·광학 특징 | float64 | 0.0000 | 389798 |
| 13 | tbp_lv_Hext | 색채·광학 특징 | float64 | 0.0000 | 390743 |
| 14 | tbp_lv_L | 색채·광학 특징 | float64 | 0.0000 | 395726 |
| 15 | tbp_lv_Lext | 색채·광학 특징 | float64 | 0.0000 | 396358 |
| 16 | tbp_lv_areaMM2 | 형태·기하 특징 | float64 | 0.0000 | 8029 |
| 17 | tbp_lv_area_perim_ratio | 형태·기하 특징 | float64 | 0.0000 | 167648 |
| 18 | tbp_lv_color_std_mean | 색채·광학 특징 | float64 | 0.0000 | 371189 |
| 19 | tbp_lv_deltaA | 색채·광학 특징 | float64 | 0.0000 | 398257 |
| 20 | tbp_lv_deltaB | 색채·광학 특징 | float64 | 0.0000 | 398886 |
| 21 | tbp_lv_deltaL | 색채·광학 특징 | float64 | 0.0000 | 396505 |
| 22 | tbp_lv_deltaLB | 색채·광학 특징 | float64 | 0.0000 | 395511 |
| 23 | tbp_lv_deltaLBnorm | 색채·광학 특징 | float64 | 0.0000 | 396877 |
| 24 | tbp_lv_eccentricity | 형태·기하 특징 | float64 | 0.0000 | 396648 |
| 25 | tbp_lv_location | 위치·공간 좌표 | object | 0.0000 | 21 |
| 26 | tbp_lv_location_simple | 위치·공간 좌표 | object | 0.0000 | 8 |
| 27 | tbp_lv_minorAxisMM | 형태·기하 특징 | float64 | 0.0000 | 75669 |
| 28 | tbp_lv_nevi_confidence | 형태·기하 특징 | float64 | 0.0000 | 395242 |
| 29 | tbp_lv_norm_border | 형태·기하 특징 | float64 | 0.0000 | 391372 |
| 30 | tbp_lv_norm_color | 형태·기하 특징 | float64 | 0.0000 | 368742 |
| 31 | tbp_lv_perimeterMM | 형태·기하 특징 | float64 | 0.0000 | 9492 |
| 32 | tbp_lv_radial_color_std_max | 형태·기하 특징 | float64 | 0.0000 | 367566 |
| 33 | tbp_lv_stdL | 색채·광학 특징 | float64 | 0.0000 | 396459 |
| 34 | tbp_lv_stdLExt | 색채·광학 특징 | float64 | 0.0000 | 390080 |
| 35 | tbp_lv_symm_2axis | 형태·기하 특징 | float64 | 0.0000 | 74825 |
| 36 | tbp_lv_symm_2axis_angle | 형태·기하 특징 | int64 | 0.0000 | 36 |
| 37 | tbp_lv_x | 위치·공간 좌표 | float64 | 0.0000 | 398446 |
| 38 | tbp_lv_y | 위치·공간 좌표 | float64 | 0.0000 | 382410 |
| 39 | tbp_lv_z | 위치·공간 좌표 | float64 | 0.0000 | 392817 |
...
| 5 | tbp_lv_stdL | Log1p + Robust Scaling | 1.5834 | 4.2813 | upper_1pct | 2804.0 | 0.004280 | 4.443414 | lower_1pct | 2804.0 | 0.003923 | 4.073130 | 4.443414 | moderate_tail_signal |
| 11 | tbp_lv_norm_border | Log1p Only | 1.1624 | 2.9500 | upper_5pct | 14017.0 | 0.001712 | 1.777746 | lower_1pct | 2804.0 | 0.001427 | 1.481138 | 1.777746 | weak_or_no_tail_signal |
| 10 | tbp_lv_deltaL | Standard Handling (기본 처리) | -1.2096 | 2.9554 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 15 | tbp_lv_H | Standard Handling (기본 처리) | -0.6586 | 2.4506 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 16 | tbp_lv_deltaB | Standard Handling (기본 처리) | -0.6677 | 2.2655 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 17 | tbp_lv_A | Standard Handling (기본 처리) | 0.5590 | 1.9263 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 18 | tbp_lv_eccentricity | Standard Handling (기본 처리) | -0.9027 | 1.6216 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 19 | age_approx | Standard Handling (기본 처리) | -0.2419 | 1.5157 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 20 | tbp_lv_symm_2axis | Standard Handling (기본 처리) | 0.8403 | 1.4800 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 21 | tbp_lv_Bext | Standard Handling (기본 처리) | 0.3104 | 1.2920 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 22 | tbp_lv_Aext | Standard Handling (기본 처리) | 0.4369 | 1.2039 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 23 | tbp_lv_C | Standard Handling (기본 처리) | 0.0775 | 1.1743 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 24 | tbp_lv_B | Standard Handling (기본 처리) | 0.1695 | 1.1436 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 25 | tbp_lv_Cext | Standard Handling (기본 처리) | 0.2113 | 1.1115 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 26 | tbp_lv_Hext | Standard Handling (기본 처리) | -0.2105 | 0.7912 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 27 | tbp_lv_y | Standard Handling (기본 처리) | -0.8463 | 0.0828 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 28 | tbp_lv_z | Standard Handling (기본 처리) | -0.4335 | 0.0496 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 29 | tbp_lv_L | Standard Handling (기본 처리) | -0.0242 | 0.0221 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 30 | tbp_lv_x | Standard Handling (기본 처리) | 0.0261 | 0.0111 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 31 | tbp_lv_Lext | Standard Handling (기본 처리) | -0.0876 | 0.0032 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 32 | tbp_lv_nevi_confidence | Standard Handling (기본 처리) | 0.4159 | 0.0000 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
| 33 | tbp_lv_symm_2axis_angle | Standard Handling (기본 처리) | -0.0073 | 0.0000 | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | weak_or_no_tail_signal |
...
| 12 | feat_color_to_border_ratio | architecture | ABCD color vs border balance | 0.3189 | 0.8124 | 0.0598 |
| 13 | feat_abcd_proxy_raw | architecture | ABCD proxy | 0.5170 | 0.9355 | 0.0333 |
| 14 | feat_symmetry_border_interaction | architecture | ABCD asymmetry x border | 0.1142 | 0.9654 | 0.0040 |
| 15 | feat_contrast_to_color_variation | color | CASH color-homogeneity | 0.3883 | 0.3843 | 0.2390 |
| 16 | feat_contrast_to_radial_variation | color | CASH color-homogeneity | 0.3568 | 0.4043 | 0.2126 |
| 17 | feat_hue_color_coupling | color | ABCD color x CASH homogeneity | 0.6658 | 0.8121 | 0.1251 |
| 18 | feat_chroma_normalized_gap | color | ABCD color | 0.5329 | 0.7684 | 0.1234 |
| 19 | feat_hue_circular_gap | color | DermNet color variety | 0.5281 | 0.7930 | 0.1093 |
| 20 | feat_color_variation_total | color | CASH homogeneity | 0.5914 | 0.9286 | 0.0422 |
| 21 | feat_red_green_normalized_gap | color | ABCD color | 0.2769 | 0.8884 | 0.0309 |
| 22 | feat_blue_yellow_normalized_gap | color | ABCD color | 0.8071 | 0.9767 | 0.0188 |
| 23 | feat_lightness_normalized_gap | color | ABCD color | 0.3884 | 0.9536 | 0.0180 |
| 24 | feat_color_contrast_ab | color | ABCD color | 0.2470 | 0.9496 | 0.0125 |
| 25 | feat_color_contrast_euclidean | color | ABCD color / DermNet multi-color | 0.3682 | 0.9676 | 0.0119 |
| 26 | feat_color_internal_external_gap | color | ABCD color contrast | 0.3682 | 0.9676 | 0.0119 |
| 27 | feat_internal_external_std_ratio | color | DermNet heterogeneity | 0.1312 | 0.9178 | 0.0108 |
| 28 | feat_age_contrast_interaction | context | Age-context proxy | 0.5209 | 0.7680 | 0.1208 |
| 29 | feat_age_size_interaction | context | Age-context proxy | 0.6628 | 0.8682 | 0.0874 |
| 30 | feat_age_perimeter_interaction | context | Age-context proxy | 0.6882 | 0.8921 | 0.0743 |
| 31 | feat_nevi_border_interaction | context | Nevus-confidence context | 0.4098 | 0.8606 | 0.0571 |
| 32 | feat_nevi_symmetry_interaction | context | Nevus-confidence context | 0.5152 | 0.8985 | 0.0523 |
| 33 | feat_age_color_interaction | context | Age-context proxy | 0.6226 | 0.9185 | 0.0508 |
| 34 | feat_age_area_interaction | context | Age-context proxy | 0.7120 | 0.9521 | 0.0341 |
| 35 | feat_age_symmetry_interaction | context | Age-context proxy | 0.1680 | 0.8853 | 0.0193 |
| 36 | feat_nevi_contrast_interaction | context | Nevus-confidence context | 0.2665 | 0.9475 | 0.0140 |
| 37 | feat_perimeter_to_long_ratio | geometry | Border length / diameter | 0.4496 | 0.6182 | 0.1716 |
| 38 | feat_diameter_color_coupling | geometry | Diameter x color | 0.7982 | 0.8433 | 0.1251 |
| 39 | feat_long_minor_difference | geometry | Diameter spread | 0.3464 | 0.7751 | 0.0779 |
| 40 | feat_diameter_symmetry_coupling | geometry | Diameter x asymmetry | 0.4304 | 0.8456 | 0.0664 |
| 41 | feat_diameter_border_coupling | geometry | Diameter x border | 0.4759 | 0.8743 | 0.0598 |
| 42 | feat_long_to_minor_ratio | geometry | ABCD diameter / geometry | 0.2082 | 0.8423 | 0.0328 |
| 43 | feat_area_eccentricity_coupling | geometry | Size x eccentricity | 0.6623 | 0.9650 | 0.0232 |
| 44 | feat_area_to_long_sq | geometry | Diameter-normalized size | 0.1491 | 0.8899 | 0.0164 |
| 45 | feat_minor_to_long_ratio | geometry | ABCD diameter / geometry | 0.2107 | 0.9340 | 0.0139 |
| 46 | feat_area_to_perimeter_sq | geometry | Compactness / circularity | 0.1790 | 0.9460 | 0.0097 |
| 47 | feat_compactness_eccentricity | geometry | Compactness x eccentricity | 0.0884 | 0.9012 | 0.0087 |
| 48 | feat_area_perim_border_coupling | geometry | Border x compactness | 0.2095 | 0.9725 | 0.0058 |
| 49 | feat_border_eccentricity_coupling | geometry | Border x eccentricity | 0.0834 | 0.9549 | 0.0038 |
| 50 | feat_area_perim_symmetry_coupling | geometry | Asymmetry x compactness | 0.1157 | 0.9777 | 0.0026 |
| 51 | feat_xz_radius | spatial | SLICE-3D spatial proxy | 0.3127 | 0.1917 | 0.2527 |
| 52 | feat_vertical_size_interaction | spatial | SLICE-3D spatial proxy | 0.6024 | 0.7393 | 0.1571 |
| 53 | feat_area_to_xyz_radius | spatial | SLICE-3D spatial proxy | 0.5408 | 0.7730 | 0.1227 |
| 54 | feat_long_to_xyz_radius | spatial | SLICE-3D spatial proxy | 0.3566 | 0.6980 | 0.1077 |
| 55 | feat_abs_z | spatial | SLICE-3D spatial proxy | 0.1096 | 0.5988 | 0.0440 |
| 56 | feat_symmetry_to_xyz_radius | spatial | SLICE-3D spatial proxy | 0.1623 | 0.7352 | 0.0430 |
| 57 | feat_xyz_radius | spatial | SLICE-3D spatial proxy | 0.3138 | 0.9918 | 0.0026 |
| 58 | feat_xy_radius | spatial | SLICE-3D spatial proxy | 0.3144 | 0.9918 | 0.0026 |
...
| 12 | feat_age_contrast_interaction | context | 0.0178 | 4872.2933 | drop_lite_family_cap | context family lite cap(1) reached |
| 13 | feat_contrast_to_color_variation | color | 0.0172 | 2329.3516 | drop_lite_family_cap | color family lite cap(3) reached |
| 14 | feat_perimeter_to_long_ratio | geometry | 0.0160 | 1239.4638 | drop_lite_high_vif_low_signal | VIF=1239.46 and abs_target_corr=0.0160 too wea... |
| 15 | feat_long_minor_difference | geometry | 0.0158 | 45.4864 | selected_lite_v3 | keep: top family representative under stricter... |
| 16 | feat_symmetry_contrast_interaction | architecture | 0.0135 | 260.2856 | drop_lite_family_cap | architecture family lite cap(3) reached |
| 17 | feat_color_to_border_ratio | architecture | 0.0127 | 6544.0105 | drop_lite_family_cap | architecture family lite cap(3) reached |
| 18 | feat_nevi_border_interaction | context | 0.0116 | 5.6269 | drop_lite_family_cap | context family lite cap(1) reached |
| 19 | feat_xz_radius | spatial | 0.0098 | 1.1388 | drop_lite_family_cap | spatial family lite cap(1) reached |
| 20 | feat_red_green_normalized_gap | color | 0.0095 | 393.6578 | drop_lite_family_cap | color family lite cap(3) reached |
| 21 | feat_long_to_minor_ratio | geometry | 0.0062 | 286.3948 | drop_lite_family_cap | geometry family lite cap(3) reached |
...
/tmp/ipykernel_445410/285540379.py:58: MatplotlibDeprecationWarning: The 'labels' parameter of boxplot() has been renamed 'tick_labels' since Matplotlib 3.9; support for the old name will be dropped in 3.11.
  axes[1, 1].boxplot(age_box_values, labels=['benign', 'malignant'], patch_artist=True, boxprops=dict(facecolor='#DCE9F6'))
```
- 코드 셀 67
```text
/tmp/ipykernel_445410/2682127199.py:51: MatplotlibDeprecationWarning: The 'labels' parameter of boxplot() has been renamed 'tick_labels' since Matplotlib 3.9; support for the old name will be dropped in 3.11.
  axes[1, 1].boxplot([sample_benign_dnn, sample_malignant_dnn], labels=['benign', 'malignant'], patch_artist=True, boxprops=dict(facecolor='#FADBD8'))
```
- 코드 셀 102
```text
/tmp/ipykernel_445410/4020431956.py:32: MatplotlibDeprecationWarning: The 'labels' parameter of boxplot() has been renamed 'tick_labels' since Matplotlib 3.9; support for the old name will be dropped in 3.11.
  axes[1].boxplot(boxplot_values, labels=boxplot_labels, patch_artist=True, boxprops=dict(facecolor='#FDEBD0'))
```
- 코드 셀 154
```text
...
### 부록 B. 문서 export 메모
1. 본 문서는 `markdown cell`과 `code cell output`만을 포함한다.
2. 이미지 출력은 별도 assets 디렉터리에 저장하고 상대경로로 연결했다.
3. DataFrame HTML 표는 markdown 표로 다시 변환해 본문에 포함했다.
4. 이미지 파일 수: `42`
